...
const getDocumentObject = () => {
  const globalObj2 = getGlobalObject();
  return globalObj2.document || {
    createElement: () => ({}),
    getElementById: () => null,
    querySelector: () => null,
    body: {
...
const Fancy$1 = {
  ...
  typeOf(value) {
    ...
    const toString = Object.prototype.toString, typeToString = toString.call(value);
    if (value.length !== void 0 && typeof value !== "function") {
      return "array";
    }
    switch (typeToString) {
      case "[object Array]":
  ...
  newElement(tag, cls, style = {}) {
    ...
    if (Array.isArray(cls)) {
      (_a = el.classList) == null ? void 0 : _a.add(...cls);
    } else if (typeof cls === "string") {
      (_b = el.classList) == null ? void 0 : _b.add(cls);
    }
    for (let p in style) {
      if (style[p] === void 0) {
        continue;
...
if (typeof globalObj !== "undefined") {
  globalObj.Fancy = globalObj.Fancy || Fancy$1;
}
...
Fancy.render = {
  boolean(params) {
    ...
    (_a = inputEl.setAttribute) == null ? void 0 : _a.call(inputEl, "type", "checkbox");
    inputEl.checked = value;
    (_b = inputEl.addEventListener) == null ? void 0 : _b.call(inputEl, "click", (e) => {
      var _a2;
      !column.editable && ((_a2 = e.preventDefault) == null ? void 0 : _a2.call(e));
    });
    (_c = inputEl.addEventListener) == null ? void 0 : _c.call(inputEl, "change", (e) => {
      var _a2;
      (_a2 = column.onCheckBoxChange) == null ? void 0 : _a2.call(column, e, inputEl.checked);
    });
    (_d = cell.classList) == null ? void 0 : _d.add(Fancy.cls.CELL_BOOLEAN);
    (_e = cell.appendChild) == null ? void 0 : _e.call(cell, inputEl);
  },
  order(params) {
    var _a;
    const {
    ...
    (_a = cell.classList) == null ? void 0 : _a.add(Fancy.cls.CELL_ORDER);
    if (cell.innerHTML !== void 0) {
...
Fancy.copyText = (text) => {
  ...
  const documentObj2 = globalObj2.document;
  if ((_a = globalObj2.navigator) == null ? void 0 : _a.clipboard) {
    globalObj2.navigator.clipboard.writeText(text).catch((err) => console.error("FG-Grid: Error copying: ", err));
  } else if (documentObj2) {
    const textarea = documentObj2.createElement("textarea");
    textarea.value = text;
    (_b = documentObj2.body) == null ? void 0 : _b.appendChild(textarea);
    (_c = textarea.select) == null ? void 0 : _c.call(textarea);
    (_d = documentObj2.execCommand) == null ? void 0 : _d.call(documentObj2, "copy");
    (_e = documentObj2.body) == null ? void 0 : _e.removeChild(textarea);
  }
};
(() => {
  class Store {
    constructor({ data, rowGroups, rowGroupExpanded, aggregations, defaultRowGroupSort }) {
      ...
      __publicField(this, "sortedData");
      __publicField(this, "filteredData");
      __publicField(this, "sorters", []);
      __publicField(this, "filters", []);
      __publicField(this, "rowGroups", []);
      __publicField(this, "rowGroupExpanded", []);
      __publicField(this, "aggregations", []);
      __publicField(this, "idRowIndexesMap", null);
      __publicField(this, "idItemMap", null);
      __publicField(this, "selectedItemsMap", null);
      __publicField(this, "selectedRowGroupsChildren", null);
      __publicField(this, "idSeed", 0);
      __publicField(this, "prevAction", "");
      const me = this;
      me.prevAction = "";
      me.data = data || [];
      ...
      me.selectedItemsMap = /* @__PURE__ */ new Map();
    ...
    setData(data) {
      const me = this;
      me.sortedData = void 0;
      me.filteredData = void 0;
      me.data = data;
      me.selectedItemsMap = /* @__PURE__ */ new Map();
      me.selectedRowGroupsChildren = {};
      if (me.data.length && me.rowGroups.length) {
    ...
    updateIndexes() {
      ...
      me.idRowIndexesMap = /* @__PURE__ */ new Map();
    ...
    getDisplayedDataTotal() {
      ...
      if (sorters.length || filters.length || rowGroups.length) {
        return ((_a = this.displayedData) == null ? void 0 : _a.length) || 0;
      }
...
(() => {
  const StoreMixinFilter = {
    ...
    filter(column, value, sign = "=", oneFilterPerColumn = false) {
      ...
      if (me.prevAction === "sort" && me.sortedData) {
        data = me.sortedData.slice();
      } else if (me.prevAction === "filter" && ((_a = me.prevFilterColumn) == null ? void 0 : _a.id) !== column.id && me.filteredData) {
        data = me.filteredData.slice();
      } else if (me.prevAction === "filter" && ((_b = me.prevFilterColumn) == null ? void 0 : _b.id) === column.id) {
  ...
  const StoreMixinRowGroup = {
    ...
    setExpandedGroups() {
      ...
      switch (typeof me.rowGroupExpanded) {
        ...
        case "boolean":
          ...
          break;
        default:
          (_a = me.rowGroupExpanded) == null ? void 0 : _a.forEach((group) => {
    ...
    generateDisplayedGroupsForFiltering(zeroLevelGroups) {
      ...
      for (let group in me.expandedGroups) {
        ...
        subGroups == null ? void 0 : subGroups.forEach(({ $rowGroupValue }) => {
          if ($rowGroupValue) {
      ...
      const recursiveDataExtraction = (levelGroups, level = 0) => {
        levelGroups.forEach((group) => {
          ...
          if (me.expandedGroups[group] && level !== me.levelsWithGroups.length - 1) {
            ...
            const levelGroups2 = me.levelsWithGroups[nextLevel][0][group];
            recursiveDataExtraction(levelGroups2, nextLevel);
          }
        });
      };
      switch (me.defaultRowGroupSort) {
      ...
      const recursiveDataExtraction = (levelGroups, level = 0) => {
        levelGroups.forEach((group) => {
          ...
          if (me.expandedGroups[group] && level !== me.levelsWithGroupsForFiltering.length - 1) {
            const nextLevel = level + 1;
            const levelGroups2 = me.levelsWithGroupsForFiltering[nextLevel][0][group];
            recursiveDataExtraction(levelGroups2, nextLevel);
          }
        });
      };
    ...
    getAggregationResult(aggregation, values) {
      ...
      if (typeof aggregation.fn === "function") {
        ...
        switch (aggregation.fn) {
          case "sum":
            result = values.reduce((sum2, value) => sum2 + value, 0);
            break;
          case "avg":
    ...
    addGroup(group) {
      ...
      for (let i = 0; i < splitted.length; i++) {
        ...
        if (groupLevel === 0) {
          ...
          if (me.levelsWithGroups[groupLevel] === void 0) {
      ...
      addToGroupsChildren.forEach((group2) => {
        const splitted2 = group2.split("/");
        if (splitted2.length === 1) {
          return;
        }
        const parentGroup = splitted2.slice(0, splitted2.length - 1).join("/");
        me.groupsChildren[parentGroup] = me.groupsChildren[parentGroup] || [];
        me.groupsChildren[parentGroup].push(me.groupDetails[group2]);
      });
    },
    agGroupUpdateData(groupName, items, sign = "-") {
      ...
      (_a = me.aggregations) == null ? void 0 : _a.forEach((aggregation) => {
...
(() => {
  const StoreMixinSelection = {
    ...
    updateSelectedRowGroupsChildren(group, value, item) {
      ...
      if (value) {
        if (selectedRowGroupsChildren[group] === void 0) {
          selectedRowGroupsChildren[group] = /* @__PURE__ */ new Set();
        }
  ...
  const StoreMixinEdit = {
    ...
    clearGroup(groupName) {
      ...
      if (level === 0) {
        ...
        if ((groupDetail == null ? void 0 : groupDetail.$hasChildrenGroups) && me.levelsWithGroups[level + 1]) {
...
(() => {
  ...
  class Scroller {
    constructor(config) {
      __publicField(this, "startRow", 0);
      __publicField(this, "endRow", 0);
      __publicField(this, "scrollTop", 0);
      __publicField(this, "scrollLeft", 0);
      __publicField(this, "maxScrollTop", 0);
      __publicField(this, "topBufferRows", 10);
      __publicField(this, "bufferRows", 30);
      __publicField(this, "extraBufferRows", 20);
      __publicField(this, "columnViewStart", 0);
      __publicField(this, "columnViewEnd", 0);
      __publicField(this, "columnsViewRange", []);
      __publicField(this, "scrollBarWidth", 17);
      __publicField(this, "isDomInvisibleScrollbar", false);
      __publicField(this, "onVerticalScroll", () => {
        const me = this;
      ...
      __publicField(this, "onHorizontalScroll", () => {
        const me = this;
        const grid = me.grid;
    ...
    renderHorizontalScroll() {
      ...
      const horizontalScrollEl = div(BODY_HORIZONTAL_SCROLL, {
        ...
        width: me.isDomInvisibleScrollbar || !me.isVerticalVisible() ? "100%" : `calc(100% - ${scrollBarWidth})`
      });
    ...
    updateHorizontalScrollSize() {
      const me = this, horizontalScrollEl = me.horizontalScrollEl;
    ...
    getColumnsViewRange() {
      ...
      for (let i = 0; i < me.grid.columns.length; i++) {
        ...
        if (columnStart === void 0 && columnPastWidth <= me.scrollLeft && columnPastWidth + column.width > me.scrollLeft) {
          columnStart = i;
        }
        if (columnStart !== void 0) {
          range.push(i);
        }
        if (columnEnd === void 0 && columnPastWidth <= me.scrollLeft + gridWidth && columnPastWidth + column.width >= me.scrollLeft + gridWidth) {
...
(() => {
  ...
  class Grid2 {
    constructor(config, extraConfig) {
      ...
      __publicField(this, "defaultColumnWidth", 120);
      __publicField(this, "headerRowHeight", 32);
      __publicField(this, "rowHeight", 28);
      __publicField(this, "rowAnimation", true);
      __publicField(this, "minColumnWidth", 35);
      __publicField(this, "rowGroupType", "row");
      // asc-string desc-string asc-amount desc-amount
      __publicField(this, "defaultRowGroupSort", "desc-amount");
      __publicField(this, "rowGroupBarSeparator", false);
      __publicField(this, "actualRowsIdSet");
      __publicField(this, "renderedRowsIdMap");
      __publicField(this, "activeCell", true);
      __publicField(this, "selectingCells", true);
      __publicField(this, "editorEnterAction", "stay");
      // 'stay' | 'down' | 'right'
      __publicField(this, "startEditByTyping", true);
      __publicField(this, "flashChanges", true);
      __publicField(this, "flashChangesColors", ["#e0e5e9", "beige"]);
      __publicField(this, "filterBar", false);
      __publicField(this, "cellsRightBorder", false);
      __publicField(this, "columnLines", false);
      __publicField(this, "rowGroupBar", false);
      __publicField(this, "$defaultRowGroupColumn", {
        title: "Group",
        width: 120,
        sortable: false,
        type: "string",
      ...
      me.initId(config.id);
      me.actualRowsIdSet = /* @__PURE__ */ new Set();
      me.renderedRowsIdMap = /* @__PURE__ */ new Map();
    ...
    initContainer(renderTo) {
      ...
      const documentObj2 = getDocument();
      if (renderTo && renderTo.tagName) {
        me.containerEl = renderTo;
      } else if (typeof renderTo === "string" && documentObj2) {
        me.containerEl = documentObj2.getElementById(renderTo);
        if (!me.containerEl) {
          me.containerEl = documentObj2.querySelector(renderTo);
        }
      }
      if (!me.containerEl) {
    ...
    renderBody() {
      ...
      const bodyInnerContainerEl = div(BODY_INNER_CONTAINER, {
        ...
        height: me.store.rowGroups.length ? me.store.getDisplayedDataTotal() * me.rowHeight + "px" : me.store.getDataTotal() * me.rowHeight + "px"
      });
    ...
    removeDomRowById(id) {
      const me = this;
      const rowEl = me.renderedRowsIdMap.get(id);
      rowEl == null ? void 0 : rowEl.remove();
      me.actualRowsIdSet.delete(id);
      me.renderedRowsIdMap.delete(id);
    }
      ...
      if (config.columns) {
        ...
        config.columns.forEach((column) => {
          if (column.rowGroup) {
            ...
            if (column.rowGroupOrder !== void 0) {
        ...
        if (newRowGroupsOrder) {
          ...
          rowGroups.forEach((group, index) => {
            if (newRowGroupsOrder[index] === void 0) {
    ...
    remove(rows) {
      ...
      let rowGroups = /* @__PURE__ */ new Map();
      ...
      rowGroups.forEach((items, groupValue) => {
        ...
        for (let i = 0; i < splitted.length; i++) {
          ...
          if (groupDetails.amount === 0) {
            ...
            store.groupsChildren[parentGroup] = store.groupsChildren[parentGroup].filter((item2) => {
              return item2.id !== groupDetails.id;
            });
      ...
      if ((_a = store.displayedData) == null ? void 0 : _a.length) {
        ...
        const rowIndexes2 = displayedItemsToRemove.sort((a, b) => a.rowIndex - b.rowIndex);
        rowIndexes2.forEach((item, index) => {
    ...
    setById(id, index, value) {
      ...
      const rowIndex = row == null ? void 0 : row.getAttribute("row-index");
      ...
      if (typeof index === "object") {
        for (let p in index) {
          ...
          let cell = row == null ? void 0 : row.querySelector(`div[col-id="${p}"]`);
          rerenderCell(cell);
        }
      } else {
        store.setById(id, index, value);
        let cell = row == null ? void 0 : row.querySelector(`div[col-id="${index}"]`);
        rerenderCell(cell);
      }
  ...
  if (typeof globalObj2 !== "undefined") {
    globalObj2.Grid = Grid2;
  }
  Fancy.Grid = Grid2;
})();
(() => {
  ...
  const GridMixinColumn = {
    ...
    generateColumnIds(columns, updateMaps = true) {
      const me = this;
      const columnIdsMap = me.columnIdsMap || /* @__PURE__ */ new Map();
      const columnIdsSeedMap = me.columnIdsSeedMap || /* @__PURE__ */ new Map();
    ...
    terminateNotExistedCells() {
      ...
      cells.forEach((cell) => {
        ...
        if (!column || !isColumnVisible) {
          cell.remove();
          column && ((_a = column.filterCellEl) == null ? void 0 : _a.remove());
          const filterCellEl = (_c = (_b = me.filterBarEl) == null ? void 0 : _b.querySelector) == null ? void 0 : _c.call(_b, `.${FILTER_BAR_CELL}[col-id="${columnId}"]`);
          filterCellEl == null ? void 0 : filterCellEl.remove();
    ...
    $setColumns(newColumns) {
      const me = this;
      const columnsToAdd = /* @__PURE__ */ new Map();
      const columnsToRemoveIds = /* @__PURE__ */ new Set();
      const {
      ...
      const newColumnsOrderMap = /* @__PURE__ */ new Map();
    ...
    prepareColumn(column, defaults = {}) {
      ...
      switch (column.type) {
        ...
        case "order":
          ...
          if ((store == null ? void 0 : store.rowGroups.length) || (me == null ? void 0 : me.rowGroupBar)) {
...
(() => {
  ...
  const GridMixinHeader = {
    ...
    renderVisibleHeaderCells() {
      const me = this;
      let columnStart = me.scroller.columnViewStart, columnEnd = me.scroller.columnViewEnd;
      for (let i = columnStart; i <= columnEnd; i++) {
        const column = me.columns[i];
        if (column.hidden) {
          continue;
    ...
    createGroupHeaderCell(columnIndex, level) {
      ...
      const cell = div([HEADER_CELL, HEADER_CELL_COLUMN_GROUP], {
        ...
        display: column.spanning ? "none" : void 0
      });
      const value = column.title;
    ...
    onCellMouseDown(event) {
      ...
      document.addEventListener("mouseup", () => {
        ...
        setTimeout(() => {
          var _a, _b;
          (_a = me.activeRowGroupBarItemEl) == null ? void 0 : _a.classList.remove(ROW_GROUP_BAR_ITEM_ACTIVE);
          me.gridEl.classList.remove(COLUMN_DRAGGING);
          (_b = me.columnDragging) == null ? void 0 : _b.dragColumnCellEl.remove();
    ...
    onResizeMouseDown(event) {
      ...
      if (cell.classList.contains(HEADER_CELL_COLUMN_GROUP)) {
        ...
        me.resizeColumnGroupChildrenWidths = me.resizeColumnGroup.children.map((column2) => !column2.hidden && column2.width).filter((value) => value !== false);
      }
      ...
      gridEl.querySelectorAll(`.${HEADER_CELL}`).forEach((cell2) => {
        cell2.style.cursor = "ew-resize";
      });
    ...
    onResizeMouseMove(event) {
      ...
      if (me.resizeColumnGroup) {
        const children = me.resizeColumnGroup.children.filter((column2) => column2.hidden !== true);
        const resizeColumnGroupChildrenWidths = me.resizeColumnGroupChildrenWidths;
        children.forEach((column2, i) => {
          column2.width = resizeColumnGroupChildrenWidths[i] + deltaX / children.length;
        });
      } else {
        column.width = newWidth;
      }
      if (column.parent) {
        column.parent.firstColumn.width = column.parent.firstColumn.children.reduce((value, column2, i) => {
          const groupLevel2Column = me.columns2[i];
          if (groupLevel2Column.spanning) {
            groupLevel2Column.width = column2.width;
            groupLevel2Column.left = column2.left;
            groupLevel2Column.headerCellEl.style.left = column2.left + "px";
            groupLevel2Column.headerCellEl.style.width = column2.width + "px";
          }
          if (column2.hidden) {
            return value;
          }
          return value + column2.width;
        }, 0);
    ...
    showHeaderCellMenuList(event, column) {
      ...
      el.innerHTML = me.columns.map((column2, index) => {
        if (column2.$isRowGroupColumn) {
          return "";
        }
        return [
          `<div col-index="${index}" class="${COLUMNS_MENU_ITEM}">`,
          `<input type="checkbox" ${column2.hidden ? "" : "checked"}>`,
          column2.parent ? `<div class="${COLUMNS_MENU_ITEM_GROUP_TEXT}">${column2.parent.title}</div>` : "",
          `<div class="${COLUMNS_MENU_ITEM_TEXT}">${column2.title}</div>`,
          "</div>"
        ].join("");
      }).join("");
    ...
    onClickHeaderMenuItem(e) {
      ...
      if (menuItem && !me.animatingColumnsPosition) {
        ...
        if (!me.isPossibleToHideColumn() && (!isInputTarget && inputCheckBox.checked || isInputTarget && !inputCheckBox.checked)) {
          if (isInputTarget) {
            e.preventDefault();
          }
          console.warn("FG-Grid: Hiding column was prevented because it requires at least 1 visible column");
    ...
    destroyHeaderCellMenuList(column) {
      ...
      if (column) {
        (_a = column.elMenuList) == null ? void 0 : _a.remove();
        delete column.elMenuList;
      } else if (me.activeElMenuList) {
        me.scroller.columnsViewRange.forEach((columnIndex) => {
          const column2 = me.columns[columnIndex];
          if (column2.elMenuList) {
            column2.elMenuList.remove();
            delete column2.elMenuList;
          }
        });
      }
    ...
    reSetVisibleHeaderColumnsIndex() {
      ...
      for (let i = 0, iL = columnsViewRange.length; i < iL; i++) {
        ...
        if (me.columnsLevel > 1) {
          ...
          const headerCellEl2 = columnGroup == null ? void 0 : columnGroup.headerCellEl;
          if (headerCellEl2 && Number(headerCellEl2.getAttribute("col-index")) !== columnIndex) {
            headerCellEl2.setAttribute("col-index", columnIndex);
          }
        }
    ...
    prepareGroupHeaderColumns(config) {
      ...
      const goThroughColumns = (columns, level, index = 0) => {
        let hasChildren = columns.some((column) => column.children !== void 0);
        columns.forEach((column) => {
          ...
          if (column.children) {
            ...
            for (; index < iL; index++, i++) {
              if (!spanned) {
                levels[level][index] = __spreadValues({
                  columnGroup: column
                }, column);
  ...
  const GridMixinBody = {
    ...
    appendCell(rowIndex, columnIndex) {
      ...
      if (rowEl.classList.contains(ROW_GROUP)) {
        ...
        if (me.rowGroupType === "column" && column.$isRowGroupColumn) {
          const cell2 = me.createCellGroupTypeColumn(rowIndex, item, columnIndex);
    ...
    createCell(rowIndex, columnIndex, allowActiveCellSet = true) {
      ...
      if (column.$type === "currency") {
        ...
        column.minDecimal !== void 0 && (params.minDecimal = column.minDecimal);
        column.maxDecimal !== void 0 && (params.maxDecimal = column.maxDecimal);
      }
      cell.setAttribute("col-index", columnIndex);
      cell.setAttribute("col-id", column.id);
      ...
      if (column.checkboxSelection) {
        ...
        valueEl.innerHTML = cellInner != null ? cellInner : "&nbsp;";
        wrapperEl.appendChild(valueEl);
        cell.appendChild(wrapperEl);
      } else if (cellInner !== void 0) {
        if (cellInner === "") {
          cellInner = "&nbsp;";
        }
        cell.innerHTML = cellInner != null ? cellInner : "&nbsp;";
      }
      if (me.activeCell) {
    ...
    createCellGroupTypeColumn(rowIndex, item, columnIndex) {
      ...
      if (column.$isRowGroupColumn) {
        ...
        const column2 = me.columns[columnIndex];
        let value = item.$agValues[column2.index] || "";
        const cell = div(CELL, {
          width: column2.width + "px",
          left: column2.left + "px"
        });
        let cellInner;
        if (column2.format) {
          value = column2.format({
            item,
            column: column2,
            rowIndex,
            columnIndex,
        ...
        cell.setAttribute("col-index", columnIndex);
        cell.setAttribute("col-id", column2.id);
        if (cellInner !== void 0) {
    ...
    removeColumnCells(columnIndexes = []) {
      ...
      columnIndexes.forEach((columnIndex) => {
        ...
        (_a = headerCell.remove) == null ? void 0 : _a.call(headerCell);
        if (me.filterBar) {
          const filterCell = me.filterBarEl.querySelector(`[col-index="${columnIndex}"]`);
          (_b = filterCell.remove) == null ? void 0 : _b.call(filterCell);
        }
    ...
    renderRow(index, item, style = {}) {
      ...
      const rowEl = div(ROW, __spreadValues({
    ...
    updateCellPositions(columnIndex) {
      const me = this;
      let columnStart = me.scroller.columnViewStart, columnEnd = me.scroller.columnViewEnd;
      if (columnIndex !== void 0 && columnStart < columnIndex) {
      ...
      me.renderedRowsIdMap.forEach((rowEl) => {
        ...
        cells.forEach((cell) => {
          const columnIndex2 = cell.getAttribute("col-index");
          const column = me.columns[columnIndex2];
          cell.style.left = column.left + "px";
          cell.style.width = column.width + "px";
        });
    ...
    reSetVisibleBodyColumnsIndex(from, to, oldOrders) {
      ...
      if (from === void 0) {
        ...
        for (let i = 0, iL = columnsViewRange.length; i < iL; i++) {
          ...
          if (me.rowGroupType === "column") {
            const cells2 = me.bodyEl.querySelectorAll(`.${ROW_GROUP_CELL}[col-index="${i}"]`);
            cells2.forEach((cell) => {
              if (Number(cell.getAttribute("col-index")) !== columnIndex) {
                cell.setAttribute("col-index", columnIndex);
              }
      ...
      for (let i = from, j = 0; i <= to; i++, j++) {
        ...
        (_a = cellsGroupMap[oldIndex]) == null ? void 0 : _a.forEach((cell) => {
          cell.setAttribute("col-index", newIndex);
        });
      }
    },
...
(() => {
  ...
  const GridMixinFilter = {
    ...
    onFilterFieldChange(value, sign, column, signWasChanged) {
      const me = this;
      if (signWasChanged) {
        me.store.removeFilter(column, void 0, false);
      }
      if (sign === "=" && value === "") {
    ...
    clearFilter(column, sign) {
      ...
      me.columns.forEach(($column) => {
        ...
        if (!column) {
          delete $column.filters;
          (_a = $column.filterField) == null ? void 0 : _a.clearValue();
          return;
        }
...
(() => {
  ...
  const GridMixinRowGroup = {
    ...
    reConfigRowGroups() {
      ...
      me.grouping = true;
      me.terminateVisibleRows();
      if (((_a = me.rowGroupBarItemColumns) == null ? void 0 : _a.length) !== void 0) {
...
(() => {
  ...
  const GridMixinRowGroupBar = {
    ...
    generateRowGroupBarItemEl(column) {
      ...
      containerEl.setAttribute("row-group-order-index", String(((_a = me.rowGroupBarItems) == null ? void 0 : _a.length) || 0));
      ...
      if ((_b = me.rowGroupBarItems) == null ? void 0 : _b.length) {
        const svgChevronRight = Fancy.svg.chevronRight;
    ...
    onRowGroupBarItemDragElMouseDown(event) {
      ...
      document.addEventListener("mouseup", () => {
        ...
        if (dragItemFromRowGroupBar && !inBar) {
          ...
          if (changedRowGroupItemOrderIndex !== void 0 && changedRowGroupItemOrderIndex !== originalRowGroupItemOrderIndex) {
            setTimeout(() => {
              me.reConfigRowGroups();
            }, 1);
          }
        ...
        me.gridEl.classList.remove(COLUMN_DRAGGING);
        columnDragging == null ? void 0 : columnDragging.dragColumnCellEl.remove();
        delete me.columnDragMouseDownColumn;
        delete me.columnDragging;
        delete me.activeRowGroupBarItemEl;
    ...
    removeGroupInBar(column) {
      ...
      delete me.activeRowGroupBarItemEl;
      if (!me.rowGroupBarItems || ((_a = me.rowGroupBarItems) == null ? void 0 : _a.length) === 0) {
    ...
    getRowGroupBarItemsRect() {
      var _a;
      const itemsRect = [];
      (_a = this.rowGroupBarItems) == null ? void 0 : _a.forEach((item) => {
...
(() => {
  ...
  const GridMixinSelection = {
        ...
        const setActivateCell = () => {
          ...
          requestAnimationFrame(() => {
            document.addEventListener("mousedown", (event2) => {
              if (!event2.target.closest(`div.${BODY}`)) {
                me.clearActiveCell();
    ...
    onBodyCellMouseEnter(event) {
      ...
      const target = event.target;
      const cell = target.closest(`.${CELL}`);
      if (!me.activeCell || me.activeCellColumnIndex === void 0 || me.activeCellRowId === void 0 || me.isSelectingCells !== true) {
        return;
      }
      const columnIndex = Number(cell.getAttribute("col-index"));
      const row = cell.closest(`.${ROW}`);
    ...
    setShiftCellUp() {
      const me = this;
      const store = me.store;
      if (!me.activeCell || me.activeCellColumnIndex === void 0 || me.activeCellRowId === void 0) {
        return;
      }
    ...
    clearActiveCell() {
      var _a, _b;
      const me = this;
      (_a = me.activeCellEl) == null ? void 0 : _a.classList.remove(ACTIVE_CELL);
      (_b = me.activeCellRowEl) == null ? void 0 : _b.classList.remove(ACTIVE_CELL_ROW);
    ...
    setActiveCell(cell) {
      ...
      const scroller = me.scroller;
      const row = cell.closest(`.${ROW}`);
      const prevRowIndex = Number((_a = me.activeCellRowEl) == null ? void 0 : _a.getAttribute("row-index"));
      const newRowIndex = Number(row.getAttribute("row-index"));
      const columnIndex = Number(cell.getAttribute("col-index"));
      const itemId = row.getAttribute("row-id");
      const column = me.columns[columnIndex];
      me.selectionCellsRange && me.clearSelectionRange();
      (_b = me.activeCellEl) == null ? void 0 : _b.classList.remove(ACTIVE_CELL);
      me.activeCellEl = cell;
      me.activeCellEl.classList.add(ACTIVE_CELL);
      (_c = me.activeCellRowEl) == null ? void 0 : _c.classList.remove(ACTIVE_CELL_ROW);
    ...
    hasActiveCell() {
      const me = this;
      return me.activeCellColumn !== void 0 && me.activeCellRowId !== void 0 && me.activeCellColumnIndex !== void 0;
    },
    ...
    setActiveCellUp() {
      ...
      if (newRowIndex === rowIndex || newRowIndex === void 0) {
        if (newRowIndex === void 0 && me.scroller.scrollTop !== 0) {
    ...
    setActiveCellLeft() {
      ...
      const row = me.activeCellRowEl;
      const rowIndex = Number(row.getAttribute("row-index"));
      if (newColumnIndex === columnIndex || newColumnIndex === void 0) {
        return;
      }
    ...
    updateHeaderCheckboxSelection(column) {
      ...
      if (!column) {
        me.scroller.columnsViewRange.forEach((columnIndex) => {
          const column2 = me.columns[columnIndex];
          column2.headerCheckboxSelection && me.updateHeaderCheckboxSelection(column2);
        });
        return;
      }
      const store = me.store;
...
(() => {
  ...
  const GridMixinKeyNavigation = {
    ...
    onKeyDown(event) {
      ...
      switch (event.keyCode) {
        ...
        default:
          ...
          if (!me.activeEditor && (code.startsWith("Key") && code.length === 4 || // KeyA - KeyZ
    ...
    onKeyENTER() {
      ...
      if (me.activeCellEl) {
        if (((_a = me.editingCell) == null ? void 0 : _a.getAttribute("id")) === me.activeCellEl.getAttribute("id")) {
          return;
        }
...
(() => {
  ...
  const GridMixinColumnDrag = {
      ...
      if (me.columnDragging) {
        ...
        if (me.rowGroupBar && me.isCursorInRowGroupBar(event, columnDragging.rowGroupBarElRect)) {
          if (!columnDragging.inBar) {
            ...
            (_a = me.rowGroupBarItemColumns) == null ? void 0 : _a.forEach((column) => {
            ...
            if (cursorInRowGroupBarItem !== void 0 && cursorInRowGroupBarItem !== activeRowGroupIndex) {
    ...
    onColumnDragging(event) {
      ...
      if (cursorInColumnIndex !== void 0 && me.columnDragMouseDownColumnIndex !== cursorInColumnIndex) {
        if (((_a = me.columns[cursorInColumnIndex]) == null ? void 0 : _a.type) === "order") {
          return;
        }
  ...
  const GridMixinEdit = {
    ...
    openEditorForCell(cell, startValue) {
      ...
      const memorizeChange = (value2) => {
        ...
        if (column.setter) {
          ...
          me.store.setById(itemId, column.index, value2);
        }
        cell == null ? void 0 : cell.remove();
        cell = me.createCell(rowIndex, columnIndex);
        me.activeCellEl = cell;
        ...
        switch (type) {
          ...
          case "date":
            ...
            column.editorField = new Fancy[Fancy.capitalizeFirstLetter(`${type}Field`)]({
              ...
              onChange(value2, fromTyping) {
                if (fromTyping === false) {
                  return;
                }
                memorizeChange(value2);
              },
              onEnter() {
                me.hideActiveEditor();
    ...
    rowCellsUpdateWithColumnRender(row, flash, allowActiveCellSet = true) {
      ...
      cells.forEach((cell) => {
        const columnIndex = Number(cell.getAttribute("col-index"));
        const column = me.columns[columnIndex];
        if (column.render === void 0 || column.type === "order" || column.index === "id") {
          return;
        }
...
(() => {
  ...
  class Field {
    ...
    onInput(event) {
      ...
      (_a = me.onChange) == null ? void 0 : _a.call(me, value, true);
    }
    onKeyDown(event) {
      var _a, _b;
      const me = this;
      switch (event.keyCode) {
        case ENTER:
          const value = event.target.value;
          (_a = me.onEnter) == null ? void 0 : _a.call(me, value);
          break;
        case ESC:
          (_b = me.onESC) == null ? void 0 : _b.call(me);
          break;
      }
    }
    setValue(value) {
      ...
      (_a = me.onChange) == null ? void 0 : _a.call(me, value, false);
    }
    focus() {
      const me = this;
      me.input.focus();
...
(() => {
  ...
  class FilterField {
    constructor(config) {
      ...
      __publicField(this, "defaultSign", "=");
    ...
    onInput(event) {
      ...
      const value = event.target.value;
      !me.preventFire && ((_a = me.onChange) == null ? void 0 : _a.call(me, value, sign, me.column, me.signWasChanged));
    ...
    destroyComboList() {
      var _a;
      const me = this;
      (_a = me.elComboList) == null ? void 0 : _a.remove();
    ...
    setValue(value, fire = true) {
      ...
      fire && ((_a = me.onChange) == null ? void 0 : _a.call(me, value, sign, me.column, me.signWasChanged));
      delete me.signWasChanged;
    }
...
module.exports = {
  Fancy: function() {
    try {
      return typeof globalThis !== "undefined" ? globalThis.Fancy : typeof window !== "undefined" ? window.Fancy : typeof global !== "undefined" ? global.Fancy : void 0;
    } catch (e) {
      return void 0;
    }
  }(),
  Grid: function() {
    try {
      var FancyRef = typeof globalThis !== "undefined" ? globalThis.Fancy : typeof window !== "undefined" ? window.Fancy : typeof global !== "undefined" ? global.Fancy : void 0;
      return FancyRef ? FancyRef.Grid : void 0;
    } catch (e) {
      return void 0;
    }
  }()
